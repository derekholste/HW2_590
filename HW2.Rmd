...
house_size = reg_function_se(envelopes$hhsize)[1],
school_coeff = reg_function_se(envelopes$schooling)[1],
age_coeff = reg_function_se(envelopes$age)[1],
sex_coeff = reg_function_se(envelopes$sex)[1],
wealth_coeff = reg_function_se(envelopes$wealth)[1],
windex_coef = reg_function_se(envelopes$windex)[1],
hyperbolic_coef = reg_function_se(envelopes$hyperbolic)[1],
hide_coeff= reg_function_se(envelopes$hided_envelope)[1]))
